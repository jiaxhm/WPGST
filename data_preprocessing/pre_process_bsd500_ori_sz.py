...
parser.add_argument("--dataset", type=str, default='/root/autodl-tmp/mamba_s/data_preprocessing/BSDS_DIR', help="where the dataset is stored")
...
map.csv is used for evaluation. 
'''
